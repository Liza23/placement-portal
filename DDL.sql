...
CREATE TABLE PROGRAM (
    ...
    program_level TEXT NOT NULL, CHECK (program_level in ('UnderGrad', 'PostGrad', 'PhD'))
);
...
CREATE TABLE JAF (
    ...
    jaf_jd TEXT NOT NULL,
    jaf_bond_duration INT NOT NULL,
    jaf_location_of_posting TEXT NOT NULL,
    jaf_currency VARCHAR(10) NOT NULL, CHECK (jaf_currency in ('INR', 'USD', 'HKD', 'JPY')),
